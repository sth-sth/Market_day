...
const TOPIC_META = {
    'Legal Compliance': { id: 'leg', label_zh: '法律合規', short_en: 'Legal Compliance', short_zh: '法律合規', icon: '01', guideIcon: '⚖️', color: '#ea6952', description_en: 'Meet applicable laws, licences and regulatory requirements before and throughout work with CLP.', description_zh: '在與中電合作前及合作期間，符合相關法律、牌照及監管要求。' },
    'Business Ethics': { id: 'eth', label_zh: '商業道德', short_en: 'Business Ethics', short_zh: '商業道德', icon: '02', guideIcon: '🤝', color: '#e99a45', description_en: 'Act with integrity and avoid bribery, improper gifts, conflicts of interest and undue influence.', description_zh: '以誠信行事，避免賄賂、不當餽贈、利益衝突及不當影響。' },
    'Cybersecurity': { id: 'cyb', label_zh: '網絡安全', short_en: 'Cybersecurity', short_zh: '網絡安全', icon: '03', guideIcon: '🔐', color: '#438bc7', description_en: 'Protect CLP information, systems and digital assets from unauthorised access, misuse or loss.', description_zh: '保護中電資料、系統及數碼資產，避免未授權存取、誤用或遺失。' },
    'Quality and Safety': { id: 'qas', label_zh: '質量與安全', short_en: 'Quality and Safety', short_zh: '質量與安全', icon: '04', guideIcon: '🛡️', color: '#3f9d82', description_en: 'Deliver products, services and work practices that meet expected quality and safety standards.', description_zh: '確保產品、服務與工作方式符合應有的質量和安全標準。' },
    'Environmental Management': { id: 'env', label_zh: '環境管理', short_en: 'Environmental Management', short_zh: '環境管理', icon: '05', guideIcon: '🌿', color: '#5db56e', description_en: 'Manage resources, waste and the environmental impact of operations responsibly.', description_zh: '負責任地管理資源、廢棄物及營運對環境造成的影響。' },
    'Climate Change': { id: 'cli', label_zh: '氣候變化', short_en: 'Climate Change', short_zh: '氣候變化', icon: '06', guideIcon: '☀️', color: '#d5a53d', description_en: 'Measure, manage and reduce greenhouse-gas emissions in support of a low-carbon transition.', description_zh: '量度、管理並減少溫室氣體排放，支持低碳轉型。' },
    'Employee Health and Safety': { id: 'ehs', label_zh: '員工健康與安全', short_en: 'Employee Health and Safety', short_zh: '員工健康與安全', icon: '07', guideIcon: '⛑️', color: '#dc6a5e', description_en: 'Provide a safe, healthy workplace and identify and control risks from work activities.', description_zh: '提供安全健康的工作環境，識別並控制工作活動帶來的風險。' },
    'Labour Practices and Human Rights': { id: 'lab', label_zh: '勞工實務與人權', short_en: 'Labour Practices and Human Rights', short_zh: '勞工實務與人權', icon: '08', guideIcon: '✊', color: '#c65e67', description_en: 'Respect labour rights and prohibit child labour, forced labour and unfair treatment.', description_zh: '尊重勞工權益，禁止童工、強迫勞動及不公平待遇。' },
    'Diversity and Inclusion': { id: 'div', label_zh: '多元與共融', short_en: 'Diversity and Inclusion', short_zh: '多元與共融', icon: '09', guideIcon: '🌈', color: '#a66ec4', description_en: 'Build a respectful, diverse and inclusive workplace free from discrimination and harassment.', description_zh: '營造尊重、多元和共融的工作環境，防止歧視與騷擾。' },
    'Community Relations': { id: 'com', label_zh: '社區關係', short_en: 'Community Relations', short_zh: '社區關係', icon: '10', guideIcon: '🏘️', color: '#4f9eb3', description_en: 'Respect community views, address grievances and support local communities responsibly.', description_zh: '尊重社區意見，妥善回應申訴，並負責任地支持本地社區。' },
    'Supply Chain Management': { id: 'sup', label_zh: '供應鏈管理', short_en: 'Supply Chain Management', short_zh: '供應鏈管理', icon: '11', guideIcon: '🔗', color: '#717cba', description_en: 'Assess and manage supply-chain risk while building sustainable partnerships with suppliers.', description_zh: '評估和管理供應鏈風險，與供應商建立可持續的合作關係。' }
};
