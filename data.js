const i18n = {
    en: {
        ...
        tutorialKicker: "Mission briefing",
        tutorialStep1Title: "Read each risk card",
        tutorialStep1Body: "Every card represents a Supplier Code of Conduct risk. Read it, then find its best-matched category.",
        tutorialStep2Title: "Send it to the right category",
        tutorialStep2Body: "Drag a card to either category rail, or tap its target category. Consecutive correct answers build a combo.",
        tutorialStep3Title: "Protect every partnership",
        tutorialStep3Body: "Make as many matches as possible in 60 seconds. A wrong answer or missed card uses one energy heart. Then complete the supplier declaration.",
        tutorialPrevious: "Previous step",
        tutorialNext: "Next step",
        tutorialStartDeclaration: "Continue to declaration",
        start: "Start Mission",
    ...
    zh: {
        ...
        tutorialKicker: "任務小教室",
        tutorialStep1Title: "讀懂風險卡",
        tutorialStep1Body: "每張卡代表一項中電供應商行為守則相關風險。閱讀內容後，找出最合適的分類。",
        tutorialStep2Title: "送到正確分類",
        tutorialStep2Body: "把卡拖到左右分類欄，也可直接點擊目標分類。連續答對能累積連擊分數。",
        tutorialStep3Title: "守護每一份合作",
        tutorialStep3Body: "在 60 秒內完成盡量多的配對；答錯或漏接會消耗一格生命能量。接著先完成供應商聲明。",
        tutorialPrevious: "上一步",
        tutorialNext: "下一步",
        tutorialStartDeclaration: "前往供應商聲明",
        start: "開始任務",
        shareBtn: "分享遊戲",
        precheckTitle: "供應商聲明",
